...
| <img height="400" alt="AI-Motion Dashboard" src="https://github.com/user-attachments/assets/dca28a96-91fa-4737-a8d9-cacdcddb8c22" /> | <img height="400" alt="AI-Motion Workflow" src="https://github.com/user-attachments/assets/d27d040d-2f03-467e-acb4-b935b4e67ad1" /> |
|---|---|
...
- [x] **前端工作流界面** - 任务列表、详情页、状态实时更新、快速生成表单
- [x] **DDD 架构搭建** - 领域层、应用层、基础设施层、接口层分离
- [x] **Docker 容器化** - 一键启动开发/生产环境
- [x] **Gemini AI 集成** - 文生图功能实现，支持漫画面板生成
- [x] **漫画生成工作流** - 简化版工作流：小说内容 → 直接生成10张漫画图片
...
**当前开发重点**：角色一致性实现、场景智能分割、小说解析引擎完善。
...
- 异步工作流系统（任务创建/状态追踪）
- 前端工作流界面（HomePage 快速生成 + 任务列表 + 任务详情）
- Gemini 2.5 Flash 文生图集成
- 简化版漫画生成工作流（小说内容 → 直接生成10张漫画）
